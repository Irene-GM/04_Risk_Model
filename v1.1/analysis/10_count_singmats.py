...
path_out_err = r"/home/irene/PycharmProjects/04_Risk_Model/data/skewed_leaves/to_keep_for_taylor/long_run_4mod_v1.0_error_metrics_NESTI_5_SPL600.csv"
path_out_zer = r"/home/irene/PycharmProjects/04_Risk_Model/data/skewed_leaves/to_keep_for_taylor/long_run_4mod_v1.0_proportion_zeros_NESTI_5_SPL600.csv"
path_out_dicex = r"/home/irene/PycharmProjects/04_Risk_Model/data/skewed_leaves/to_keep_for_taylor/DICEX_NESTI_5_SPL600.txt"


path_dump = r'/home/irene/PycharmProjects/04_Risk_Model/data/skewed_leaves/to_keep_for_taylor/dump_1000_5_v2.txt'
f = open(path_dump, "w")
...
def tiny_poisson(l):
    ...
    try:
        ...
        f.write("Poi: Allzeros\n")
    except ValueError as e:
        f.write("Poi: Infinities\n")
...
def tiny_zip(l):
    ...
    try:
        ...
        f.write("Zip: All zeros\n")
    except ValueError as e:
        print("\t\t\tIgnored output containing np.nan or np.inf")
        f.write("Zip: Infinities\n")
        pass
    return zip_res
...
def tiny_zinb(l):
    ...
    try:
        ...
        f.write("zinb: all zeros\n")
    except ValueError as e:
        print("\t\t\tIgnored output containing np.nan or np.inf")
        f.write("zinb: Infinities\n")
        pass
    return zinb_res
...
def print_exceptions(pack):
    ...
    # global dicex_elems
    # dicex_elems.append(json.dumps(dicex))
...
# with open(path_out_dicex, "w", newline="") as w:
#     for row in dicex_elems:
#         print(row)
#         w.write(row + '\n')
