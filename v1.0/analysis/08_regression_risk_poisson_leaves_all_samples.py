...
# print(rmse)
#
# print(p.shape, meta_p.shape)
#
# predictions_nl = np.mean(poisson_predictions_testing_nl(dicori, dicpoi, p), axis=1).reshape(-1, 1)
#
# print(meta_p.shape, predictions_nl.shape)
#
# stack = np.hstack((meta_p, predictions_nl))
#
# print(stack.shape)
#
# path_pred_out = r"/home/irene/PycharmProjects/04_Risk_Model/data/out/NL_TB_pixel_500m.csv"
#
# np.savetxt(path_pred_out, stack, delimiter=";")
